...
class Item {
    constructor({ item_id, name, category, description, price, image_url }) {
    ...
    static async create(newItem) {
        const { name, category, price, description, image_url } = newItem
        const response = await db.query('INSERT INTO items (name, category, price, description, image_url) VALUES ($1, $2, $3, $4, $5) RETURNING *;', [name, category, price, description, image_url])
